...
Exp: 
    ...
    | Exp LT Exp            { $$ = new_Node_l("Exp", @$.first_line); addChild($$, $1); addChild($$, $2); addChild($$, $3);if(!(checkINTexp($1,1)&&checkINTexp($3,1))){printType7Error(@$.first_line);}$$->type_value=new_prim_type("bool");}
    | Exp LE Exp            { $$ = new_Node_l("Exp", @$.first_line); addChild($$, $1); addChild($$, $2); addChild($$, $3);if(!(checkINTexp($1,1)&&checkINTexp($3,1))){printType7Error(@$.first_line);}$$->type_value=new_prim_type("bool");}
    | Exp GT Exp            { $$ = new_Node_l("Exp", @$.first_line); addChild($$, $1); addChild($$, $2); addChild($$, $3);if(!(checkINTexp($1,1)&&checkINTexp($3,1))){printType7Error(@$.first_line);}$$->type_value=new_prim_type("bool");}
    | Exp GE Exp            { $$ = new_Node_l("Exp", @$.first_line); addChild($$, $1); addChild($$, $2); addChild($$, $3);if(!(checkINTexp($1,1)&&checkINTexp($3,1))){printType7Error(@$.first_line);}$$->type_value=new_prim_type("bool");}
    | Exp NE Exp            { $$ = new_Node_l("Exp", @$.first_line); addChild($$, $1); addChild($$, $2); addChild($$, $3);if(!(checkINTexp($1,1)&&checkINTexp($3,1))){printType7Error(@$.first_line);}$$->type_value=new_prim_type("bool");}
    | Exp EQ Exp            { $$ = new_Node_l("Exp", @$.first_line); addChild($$, $1); addChild($$, $2); addChild($$, $3);if(!(checkINTexp($1,1)&&checkINTexp($3,1))){printType7Error(@$.first_line);}$$->type_value=new_prim_type("bool");}
